    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="w-64 bg-[#1E40AF] text-white flex flex-col border-r border-[#1E40AF]" style={{fontFamily: '"Inter", sans-serif'}}>
        ...
        <nav className="flex-1 overflow-y-auto py-2 px-2">
          ...
          <button onClick={() => handleNavigation("settings", "TeacherSettings")} className={`w-full px-4 py-2.5 flex items-center gap-3 transition-all text-sm font-medium rounded-lg mb-1 ${activeNav === "settings" ? "bg-white/20" : "hover:bg-white/10"}`}>
