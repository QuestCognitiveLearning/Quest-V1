  ...
  const checkAuthAndRedirect = async () => {
    ...
    try {
      ...
      if (user.account_type === "student") {
        const studentPages = ["LiveSessionPlay", "KnowledgeMap", "JoinClass", "Classes", "LearningHub", "Progress", "NewSession", "PracticeSession", "Curriculum", "SocraticInquiry", "StudentLiveSessions", "AssignedSessionPlay", "AssignedTestPlay", "Pricing", "Generate"];
